...
public class BattleStateMachine : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        {
            EnemysInBattle.Add(Instantiate(Enemys[Random.Range(0,Enemys.Length)],EnemySpawnPos[i]));
        }
    ...
    public void AddPower(BaseHero hero, Power power)
    {
