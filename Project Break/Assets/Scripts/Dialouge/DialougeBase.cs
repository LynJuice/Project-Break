...
[System.Serializable]
public struct ScriptableAnwser
{
...
public class DialougeBase : MonoBehaviour
{
    ...
    [Header("Anwser")]
    [SerializeField] Button AnwserA;
    [SerializeField] Button AnwserB;
    [SerializeField] Button AnwserC;

    bool Open;

    [SerializeReference] ScriptableConversation TestConversation;
